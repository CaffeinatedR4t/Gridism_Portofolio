...
const ConnectSection = () => {
    ...
    return (
        <section data-theme="light" className="min-h-screen grid grid-cols-2 justify-items-center items-center">
            <div className="flex flex-1 flex-col gap-10 bg-yellow-100">
                <div className={theme.spacing.primarySpacing}>
                    <p className={theme.typography.fontBold}>Address</p>
                    <p className={`max-w-[35%] ${theme.typography.fontLight}`}>Summit Tower, 17th Floor Jl. Jendral Sudirman No. 45 SCBD, Jakarta 12190 Indonesia</p>
                ...
                <h1 className={`content-end ${theme.typography.fontLightBig}`}>Let's Connect</h1>
            </div>
            <div className={`flex flex-1 w-[80%] bg-green-100 ${theme.spacing.primarySpacing}`}>
